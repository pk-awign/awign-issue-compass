-- Assign 50 random tickets to Mumbai Ticket Admin (ID: 9876543220)
-- This script randomly selects 50 tickets and assigns them to the specified ticket admin

-- First, let's get the ticket admin's user ID
DO $$
DECLARE
    admin_user_id UUID;
