...
-- Step 5: Check if any ticket_admin_assignments exist
SELECT 
...
-- If ticket_admin_assignments table doesn't exist, create it
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT FROM information_schema.tables 
    ...
    ELSE
        RAISE NOTICE 'ticket_admin_assignments table already exists';
    END IF;
END $$;
